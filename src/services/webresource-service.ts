...
// Re-export the generic binary content resolver under its legacy name so existing
// importers keep working. New callers should import `resolveBinaryContent`
// directly from `../services/file-content.js`.
export { resolveBinaryContent as resolveWebResourceContent } from './file-content.js';
